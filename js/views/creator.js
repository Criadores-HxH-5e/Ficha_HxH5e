        function renderCreator(container) {
             if (!state.tempChar) { state.tempChar = { name: '', class: SYSTEM_DB.classes[0].id, race: 'Humano Comum', attributes: { FOR:10, DES:10, CON:10, INT:10, SAB:10, PRE:10 }, skills: [], otherSkills: [], raceTraits: [], traitDetails: {}, background: null, backgroundFeature: null, inclinations: { positive: [], negative: [] }, fagogenese: null }; }
