window.COMBAT_INCLINATIONS_DB = [
  ...
  {
    id: 'arsenal_militar',
    nome: 'Arsenal Militar',
    tiers: [
      'Te dá acesso a armas simples científicas.',
      'Te dá acesso a armas complexas científicas.',
      'Te dá acesso a armas especiais científicas e de cerco.'
    ]
  },
  {
    id: 'conjurador_de_guerra',
  ...
  },
  {
    ...
    tiers: [
      'Vantagem em ataques corpo-a-corpo contra alvos desmontados menores que sua montaria/veículo.',
      'Reação para redirecionar ataque da montaria para você ou vice-versa; atacante refaz a jogada.',
      'Montaria/veículo recebe +2 de CA ou no dano quando conduzido por você.'
    ]
  },
  {
    id: 'defensiva_bruta',
    nome: 'Defensiva Bruta',
    tiers: [
  ...
  },
  {
    ...
    nome: 'Experiente',
    tiers: [
      'Registra características de combate de inimigos engajados (ação principal; ação bônus se Cientista/Técnico).',
      'Adiciona 1d6 (+prof) contra todos os aspectos analisados de um inimigo já analisado.',
      'Escolha: (1) dobra prof. da análise; (2) analisa +1 inimigo por rodada; ou (3) imune a Intimidação e Enganação de alvos analisados.'
    ]
  },
  {
    id: 'imobilizador',
  ...
  },
  {
    ...
    req: 'Prof. em Armadura Média',
    tiers: [
      'Armadura média não impõe desvantagem, prejuízo ou limitação.',
      'Pode adicionar até 4 de DES à CA em vez do máximo 3.',
      'Aumenta a durabilidade da armadura média em 2.'
    ]
  },
  {
    id: 'maestria_armadura_pesada',
    nome: 'Maestria em Armadura Pesada',
    req: 'Prof. em Armadura Pesada',
    tiers: [
      'Eficiência da armadura aumenta em 2 (bônus à CA).',
      'Acertos que igualam à CA recebem 3 de redução de dano.',
      'Aumenta a durabilidade da armadura pesada em 2.'
    ]
  },
  {
    id: 'mestre_de_armas',
  ...
  },
  {
    ...
    req: 'FOR 16+',
    tiers: [
      'Em acerto crítico ou ao reduzir alvo a 0 PV, Ação Bônus para ataque extra corpo-a-corpo (uma vez por rodada).',
      'Antes de atacar com arma pesada: –5 no ataque e +10 no dano.',
      'Armas com Alcance ou Duas Mãos recebem propriedade Mortal ×3.'
    ]
  },
  {
    id: 'mestre_de_escudo',
