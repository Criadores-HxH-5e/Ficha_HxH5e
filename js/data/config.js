...
const SYSTEM_DB = {
    ...
    racas: [
        ...
        { nome: "Fanalis", descricao: "Composição física descomunal.", aumento_atributo: { "FOR": 4, "CON": 2, "DES": -2, "INT": -2, "SAB": -2, "PRE": -2 }, opcoes_caracteristica: [
            { nome: 'Instinto Predatório', efeito: "Quando um inimigo o atinge com um ataque corpo a corpo, você pode usar sua reação para atacar desarmado ou com arma leve corpo a corpo imediatamente contra o agressor, com os benefícios de um contra-ataque (mas não os malefícios). 1x/dia; ao final da rodada, ganha 1 de exaustão. Não funciona se o oponente estiver furtivo." },
            { nome: 'Fúria Muscular', efeito: 'Quando seu PV cai abaixo de 20%, entra em vigor explosivo por 1 minuto: +2 em jogadas de ataque corpo a corpo e +1d6 de dano adicional em ataques físicos. Após o efeito, ganha 1 nível de exaustão.' },
            { nome: 'Pele de Ferro', efeito: 'Uma vez por dia, como reação, reduz à metade o dano de um ataque corpo a corpo que o acertaria.' },
        ], fonte: "[3, 4]", categoria: "Humanos e Tribos" },
        { nome: "Gyudondond", descricao: "Homens Flauta.", aumento_atributo: "Distribua 3 pontos em qualquer atributo", opcoes_caracteristica: [
            { nome: 'Alarido de Guerra', efeito: 'Membros da Tribo Gyudondond podem utilizar Intimidação como ação de movimento ao performar uma dança, desde que sua aura esteja ativa (qualquer Princípio ou Técnica de NEN, exceto Zetsu). Efeito adicional: se falhar a Intimidação, o alvo ainda sofre -1 em seu próximo teste de concentração, percepção ou intuição (por distração sonora). Limite: 1 vez por turno.' },
            { nome: 'Harmonia de Aura', efeito: 'Ação de movimento. A vibração sonora dos tubos corporais ajuda o fluxo da aura. Enquanto o Gyudondond estiver emitindo sons ritmados (passivamente ou propositalmente), recebe +1 em testes de concentração em seus Hatsus. Perde o bônus se estiver em silêncio absoluto, surdo ou impedido de se mover.' },
        ...
        { nome: "Imuchack", descricao: "Guerreiros gélidos.", aumento_atributo: { "FOR": 2, "CON": 1, "INT": -2 }, opcoes_caracteristica: [
            { nome: 'Resistência Glacial', efeito: 'Reduz todo o dano de frio ou gelo em 50% (inclusive dano de aura elemental). Nenhum teste de Resistência Física sofre penalidade por frio. Pode manter Ten ativo por +2 turnos adicionais em ambientes gelados naturais.' },
            { nome: 'Caça Aquática', efeito: "Nada sem penalidade de movimento dentro d'água e prende a respiração por Minutos = 1 + (CON × 2)." },
            { nome: 'Ritual de Maturidade', efeito: '+1 ponto permanente em FOR ou CON.' },
        ], fonte: "[3, 4]", categoria: "Humanos e Tribos" },
        // Clãs Especiais
        { nome: "Kurta", descricao: "Olhos Escarlates.", aumento_atributo: { "INT_ou_SAB": 2 }, caracteristicas: [
            { nome: 'Mudança Escarlate', efeito: '+1 em todos os atributos enquanto os olhos estiverem vermelhos. Testes de Intimidação, Intuição e Concentração têm vantagem. Ao conhecer NEN, ativa consumindo 10% de aura. Duração: rodadas iguais ao bônus de Sabedoria (mín. 1). Pode ser usado um número de vezes por dia igual à proficiência. Após a ativação, sofre 1 nível de Exaustão pelo esforço físico e mental.' },
            { nome: 'Caça Fascinante', efeito: 'Você pode ser procurado e caçado, caso descubram seus olhos e sua origem.' },
            { nome: 'Sofrimento Profundo', efeito: 'Seus olhos se tornam escarlates após um estresse mental extenuante: estar com menos de 20% de vida; sofrer dano psíquico além da metade da vida; estar Amedrontado/Assustado/Aterrorizado por quem já lhe causou +25% de dano; ou ver amigos próximos morrendo.' },
        ], fonte: "[5, 6]", categoria: "Clãs Especiais" },
        // Formigas Quimera
        {
        ...
        { nome: "Wormorfos", descricao: "Povo verme.", aumento_atributo: "Nenhum", caracteristicas: [
            { nome: 'Ecolocalização', efeito: 'Possui ecolocalização de 5m, não precisando depender dos sentidos de visão e audição quando submerso no solo.' },
            { nome: 'Deslocamento Subterrâneo', efeito: '9m comum e 4,5m subterrâneo.' },
        ], opcoes_caracteristica: [
            { nome: 'Corpo Malemolente', efeito: 'Resistência a dano de impacto/concussão (corpo menos rígido, adapta-se e "engloba" o impacto). Em contrapartida, sofre 1/4 (25%, arredondado para cima) a mais de dano perfurante ou cortante, por ter estrutura mais vulnerável a penetrações.' },
            { nome: 'Enterrada', efeito: 'Além de se submergir, pode puxar inimigos para o solo: usa "Agarrão/Puxão" contra a CA do alvo no lugar de um Teste Contestado. Em caso de sucesso, pode gastar a Ação Bônus para submergir puxando o alvo para o solo, aplicando as condições "Caído" e "Imóvel".' },
        ], fonte: "[5, 6]", categoria: "Modificados e Fantasia" },
        { nome: "Elfos e Meio-Elfos", descricao: "Herança feérica.", aumento_atributo: "Escolha +2", caracteristicas: [
            { nome: 'Visão na Penumbra', efeito: 'Enxerga na penumbra a até 18m no escuro. Sua percepção capta o fluxo vital de plantas e animais, permitindo detectar seres vivos mesmo através de folhagens densas, desde que não estejam ocultos por Zetsu.' },
        ], opcoes_caracteristica: [
            { nome: 'Pulsar Verde', efeito: 'Durante descansos ou meditações em ambientes naturais, recupera +1 ponto adicional de exaustão e reduz pela metade os efeitos de exaustão por clima, fome ou sede. Uma vez por combate, ganha +1 em qualquer teste de Resistência ou Reflexo até o final do turno.' },
            { nome: 'Fluxo Harmônico', efeito: 'Vantagem em testes de Percepção, Furtividade e Sobrevivência em ambientes naturais. Pode neutralizar/acalmar criaturas agressivas (teste de Carisma vs Sabedoria da criatura, 1x/missão).' },
            { nome: 'Expiração Vital', efeito: 'Vantagem em testes de resistência física contra venenos, toxinas e doenças.' },
        ], fonte: "[5, 6]", categoria: "Modificados e Fantasia" },
        { nome: "Meio-Orcs", descricao: "Guerreiros robustos.", aumento_atributo: { "FOR": 1, "CON": 1 }, caracteristicas: [
            { nome: 'Visão na Penumbra', efeito: 'Enxerga na penumbra a até 18m no escuro.' },
            { nome: 'Resistência Implacável', efeito: 'Quando reduzido a 0 pontos de vida sem morrer completamente, pode voltar para 1 ponto de vida. Utilizável um número de vezes por dia igual à sua proficiência.' },
        ], fonte: "[5, 6]", categoria: "Modificados e Fantasia" },
        { nome: "Anões", descricao: "Robustos.", aumento_atributo: { "CON": 2 }, caracteristicas: [
            { nome: 'Visão na Penumbra', efeito: 'Enxerga na penumbra a até 18m no escuro.' },
            { nome: 'Deslocamento', efeito: '7,5m.' },
        ], opcoes_caracteristica: [
            { nome: 'Resiliência Anã', efeito: 'Vantagem em testes de resistência contra toxinas e venenos, e resistência contra efeitos de fadiga ou envenenamento por aura.' },
            { nome: 'Estabilidade de Aura', efeito: 'Redução de 10% no custo para manter técnicas passivas (Ten constante, Gyo prolongado — gasto mínimo de 5%).' },
            { nome: 'Instinto de Forja', efeito: '+2 em testes relacionados à criação, manutenção ou modificação de equipamentos (mesmo por meio de Hatsu). Identifica o equilíbrio de aura em objetos sem precisar de Gyo.' },
        ], fonte: "[7]", categoria: "Modificados e Fantasia" },
        { nome: "Draconatos", descricao: "Herança dragão.", aumento_atributo: "Escolha +2", caracteristicas: [
            { nome: 'Resistência Ancestral', efeito: 'Resistência ao elemento ligado à cor do seu ancestral dracônico (ver tabela do manual: Azul/Bronze/Cobre-Elétrico ou Ácido, Branco-Frio, Latão/Ouro/Vermelho-Fogo, Negro-Ácido, Prata-Elétrico, Verde-Veneno).' },
            { nome: 'Arma de Sopro', efeito: 'Ação Principal: ataque em área, TR = 10 + CON + Proficiência. Dano 2d6 num fracasso (metade num sucesso); 3d6 no 6º nível; 4d6 no 11º nível. Formato e atributo do TR variam pela cor do ancestral (linha 1,5m/9m com TR de DES, ou cone de 4,5m com TR de DES/CON).' },
        ], fonte: "[7]", categoria: "Modificados e Fantasia" },
        { nome: "Halflings", descricao: "Pequenos e sortudos.", aumento_atributo: { "DES": 1, "INT": 2 }, caracteristicas: [
            { nome: 'Tamanho Pequeno', efeito: 'Deslocamento de 7,5m.' },
        ], opcoes_caracteristica: [
            { nome: 'Sortudo', efeito: 'Quando obtiver um 1 natural em uma jogada de ataque, teste de habilidade ou teste de resistência, pode rolar novamente e deve usar o novo resultado (1x por dia/sessão).' },
            { nome: 'Bravura', efeito: 'Vantagem em testes de resistência contra ficar Amedrontado/Intimidado.' },
            { nome: 'Agilidade Halfling', efeito: 'Pode mover-se através do espaço de qualquer criatura de tamanho maior que o seu.' },
        ], fonte: "Extra", categoria: "Modificados e Fantasia" },
        { nome: "Gnomos", descricao: "Inventores.", aumento_atributo: "Escolha +2", caracteristicas: [
            { nome: 'Tamanho Pequeno', efeito: 'Deslocamento de 7,5m.' },
            { nome: 'Visão na Penumbra', efeito: 'Enxerga na penumbra a até 18m no escuro.' },
        ], opcoes_caracteristica: [
            { nome: 'Percepção Pequenina', efeito: 'Vantagem em testes de Percepção e Análise de Aura.' },
            { nome: 'Esperteza Gnômica', efeito: 'Vantagem em todos os testes de resistência de Inteligência, Sabedoria e Carisma contra Hatsu.' },
            { nome: 'Tamanho ao Meu Favor', efeito: '+2 em testes de Esquiva; -1 em testes de Força física pura (empurrar, puxar ou levantar algo pesado).' },
        ], fonte: "Extra", categoria: "Modificados e Fantasia" },
        { nome: "Golias", descricao: "Gigantes de pedra.", aumento_atributo: "Escolha +2", caracteristicas: [
            { nome: 'Tamanho Médio', efeito: 'Deslocamento de 9m.' },
        ], opcoes_caracteristica: [
            { nome: 'Resistência de Pedra', efeito: 'Após receber um dano, reduz à metade o dano de impacto, perfurante ou cortante recebido — um número de vezes por dia igual à sua proficiência.' },
            { nome: 'Alvo Destroçado', efeito: 'Usa FOR em vez de DES para calcular a precisão em ataques de arremesso manual com armas.' },
            { nome: 'Corpo de Pedra', efeito: 'Vantagem em testes de resistência contra fadiga, frio e calor.' },
        ], fonte: "Extra", categoria: "Modificados e Fantasia" },
        // Tecnológicos e Sobrenaturais
        { nome: "Neans", descricao: "Andróides.", aumento_atributo: "Varia", caracteristicas: [
            { nome: 'Tamanho e Deslocamento', efeito: 'Tamanho de Miúdo até Grande. Deslocamento igual a 2 tipos diferentes de movimento, dependendo de sua "programação".' },
            { nome: 'Atualização de Disco Rígido', efeito: 'Pode alterar no início de cada dia os pontos de atributo que recebe, enquanto reavalia e limpa dados de seu "núcleo-processador e disco rígido" na medida que evolui.' },
            { nome: 'Curto Circuito', efeito: 'Não fica exausto biologicamente, mas recebe a mesma condição ao entrar em curto-circuito por dano elétrico.' },
        ], fonte: "[8, 9]", categoria: "Tecnológicos e Sobrenaturais" },
        { nome: "Vampiros", descricao: "Seres noturnos.", aumento_atributo: { "INT": 2, "Físico": 1 }, caracteristicas: [
            { nome: 'Tamanho e Deslocamento', efeito: 'Tamanho Médio. Deslocamento de 9m comum e 3m planar (aumenta em 3m para cada casta que sobe: Vampiro, Lorde Vampiro, Conde Vampiro, Imperador Vampiro).' },
            { nome: 'Sugar Aura', efeito: 'Após um ataque de mordida bem-sucedido, pode gastar a Ação Bônus para o alvo rolar um TR de CON (CD = 10 + CON + Prof. do vampiro). Se falhar, o vampiro rouba 10% da aura dele, +10% para cada 5 pontos de diferença na falha.' },
            { nome: 'Exposição Solar', efeito: 'Após 2 rodadas sob a luz do sol, sofre -5 na CA até sair do contato com a luz. Aparições durante o dia em locais protegidos aplicam só -2 na CA.' },
        ], fonte: "[8, 9]", categoria: "Tecnológicos e Sobrenaturais" },
        { nome: "Djins", descricao: "Nen Post-Mortem.", aumento_atributo: "Escolha +2", caracteristicas: [
            { nome: 'Interpretação Travessa/Trapaceira', efeito: 'Uma vez por dia/cena/missão/semana, usuários de NEN podem rolar um dado aleatório entre a quantidade de suas Restrições/Condições para ignorar a que for sorteada naquela ativação. Regra geral: a duração do Hatsu escolhido precisa ser "Instantânea"; para os demais critérios, consulte seu mestre após a definição completa do Hatsu.' },
        ], fonte: "Extra", categoria: "Tecnológicos e Sobrenaturais" },
        // Raças Incomuns
        { nome: "Bugbears", descricao: "Brutais.", aumento_atributo: { "FOR": 2, "DES": 1 }, caracteristicas: [
            { nome: 'Visão no Escuro', efeito: 'Enxerga na penumbra a até 18m como se fosse luz plena, e no escuro como se fosse penumbra.' },
        ], opcoes_caracteristica: [
            { nome: 'Ataque Surpresa', efeito: 'Ao surpreender um alvo e acertá-lo no primeiro ataque do combate, causa 2d6 de dano extra e ataca com vantagem (por estar em furtividade). Só uma vez por alvo combatido.' },
            { nome: 'Instinto Adaptativo', efeito: 'Após três rodadas lutando contra o mesmo oponente, ganha +1 de acerto contra aquele alvo específico.' },
            { nome: 'Percepção Instintiva', efeito: 'Uma vez por combate, ao ser alvo de um ataque surpresa (ou de uma técnica oculta de Nen), pode reagir automaticamente gastando 2 reações em vez de precisar de 1 disponível normalmente.' },
            { nome: 'Pressão de Predador', efeito: 'Ao ativar Ren, causa um efeito intimidador mesmo sem querer: teste contestado de Intimidação com vantagem para o Bugbear; se o alvo falhar, fica intimidado até o final da rodada (contra animais/iniciantes pode causar Amedrontado). Usável um número de vezes por dia igual à proficiência.' },
        ], fonte: "Extra", categoria: "Raças Incomuns" },
        { nome: "Dahllans", descricao: "Meio-Dríades.", aumento_atributo: { "SAB": 4, "INT": -1, "PRE": -1 }, caracteristicas: [
            { nome: 'Visão no Escuro', efeito: 'Enxerga na penumbra a até 18m como se fosse luz plena, e no escuro como se fosse penumbra.' },
        ], opcoes_caracteristica: [
            { nome: 'Empatia Natural', efeito: 'Testes sociais de Persuasão e Intuição recebem +1 contra seres conscientes. Sente emoções superficiais de seres vivos tocados ou em interação direta, desde que não estejam em Zetsu total — uma forma primitiva de leitura emocional, sem invadir a mente.' },
            { nome: 'Dr. Dolittle', efeito: 'Capaz de entender e falar com animais, podendo conversar, pedir informações ou apenas irritá-los. Insetos, animais terrestres, marinhos e bestas mágicas se encaixam, desde que possuam INT acima de 0.' },
        ], fonte: "Extra", categoria: "Raças Incomuns" },
        { nome: "Firbolgs", descricao: "Guardiões.", aumento_atributo: { "SAB": 2, "FOR": 1 }, caracteristicas: [
            { nome: 'Passo Oculto', efeito: 'Em ambiente de natureza (florestas e afins), pode usar Ação Bônus + movimento para se "transportar" de uma árvore/arbusto a outra sem ser percebido, em até 12m. Usável por dia um número de vezes igual ao modificador de Sabedoria.' },
        ], fonte: "Extra", categoria: "Raças Incomuns" },
        { nome: "Goblins", descricao: "Maliciosos.", aumento_atributo: "Escolha +2", caracteristicas: [
            { nome: 'Visão no Escuro', efeito: 'Enxerga na penumbra a até 9m como se fosse luz plena, e no escuro como se fosse penumbra.' },
            { nome: 'Fúria do Pequeno (Nanico)', efeito: 'Ao causar dano a uma criatura maior que você (ataque ou Hatsu), pode causar dano adicional igual à sua proficiência somada ao seu nível de personagem. Após usar, só pode usar de novo após terminar um descanso.' },
        ], fonte: "Extra", categoria: "Raças Incomuns" }
    ],
    // rev. Manual (Enciclopédia de Raças) — "Esforço no lugar de talento" (Humano Comum): o Humano
    // pode abrir mão de nada e escolher UMA característica (não o bônus de atributo) de uma destas
    // 6 raças. Estrutura separada da `racas` acima para não interferir em quem joga essas raças
    // diretamente (cujas entradas em `racas` já têm suas próprias — e incompletas — listas de traço).
    esforcoRacas: {
        'Fanalis': {
    ...
    // rev. Manual (Enciclopédia de Raças, seção "Formigas Quimera") — referências prontas de F.Q.
    // adaptadas de bestas comuns, agrupadas pela mesma categoria de `fagogenese_options` da raça
    // acima. `deslocamentoTipo`/`deslocamentoValor` vêm do deslocamento real da criatura no livro
    // (voo/escalada/aquático substituem ou complementam o terrestre padrão de 9m); `tracosSugeridos`
    // aponta para IDs de `caracteristicas`/`opcoes` já existentes na raça Formiga Quimera — são só
    // sugestões pré-marcadas na criação, o jogador pode trocar livremente. "Bestas Mágicas" não tem
    // referências prontas no livro (usa só o menu de características livre).
    fqPresets: {
        'Ave': [
            { nome: 'Águia', desloc: '10,5m (Voo) / 9m Terrestre', deslocamentoTipo: 'voo', deslocamentoValor: 10.5, tracosSugeridos: [{ nome: 'Arma natural', opcao: 'Bico' }, { nome: 'Rasante' }] },
            { nome: 'Beija-flor', desloc: '7,5m (Voo) / 3m Terrestre', deslocamentoTipo: 'voo', deslocamentoValor: 7.5, tracosSugeridos: [{ nome: 'Evasão', opcao: 'Aérea' }] },
            { nome: 'Condor/Urubu', desloc: '12m (Voo) / 9m Terrestre', deslocamentoTipo: 'voo', deslocamentoValor: 12, tracosSugeridos: [{ nome: 'Evasão', opcao: 'Aérea' }] },
        ],
        'Mamífero': [
            { nome: 'Coelho', desloc: '10,5m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 10.5, tracosSugeridos: [{ nome: 'Destreza animal' }] },
            { nome: 'Elefante', desloc: '7,5m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 7.5, tracosSugeridos: [{ nome: 'Tração Animal' }, { nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Impacto' }] },
            { nome: 'Guepardo', desloc: '12m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 12, tracosSugeridos: [{ nome: 'Destreza animal' }] },
            { nome: 'Leão', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Arma natural', opcao: 'Presas (Mordida)' }, { nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Corte' }] },
            { nome: 'Lobo', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Arma natural', opcao: 'Presas (Mordida)' }] },
            { nome: 'Macaco', desloc: '9m (Escalada)', deslocamentoTipo: 'escalada', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Destreza animal' }, { nome: 'Corpo Adaptável', opcao: 'Corpo Mole (Resistência Impacto)' }] },
            { nome: 'Rinoceronte', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Investida' }, { nome: 'Tração Animal' }] },
            { nome: 'Tatu', desloc: '7,5m Terrestre (+9m Subterrâneo)', deslocamentoTipo: 'terrestre', deslocamentoValor: 7.5, tracosSugeridos: [{ nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Impacto' }, { nome: 'Investida' }] },
        ],
        'Réptil/Anfíbio': [
            { nome: 'Camaleão', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Regeneração' }] },
            { nome: 'Cobra', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Corte' }] },
            { nome: 'Sapo', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Corpo Adaptável', opcao: 'Constituição Respiratória (Aquático)' }, { nome: 'Veneno/Peçonha' }] },
            { nome: 'Tartaruga', desloc: '6m (Nado)', deslocamentoTipo: 'aquatico', deslocamentoValor: 6, tracosSugeridos: [{ nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Impacto' }] },
        ],
        'Aquático': [
            { nome: 'Baleia', desloc: '9m (Nado) / 9m Terrestre', deslocamentoTipo: 'aquatico', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Tração Animal' }] },
            { nome: 'Lagosta', desloc: '9m (Nado) / 9m Terrestre', deslocamentoTipo: 'aquatico', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Corte' }] },
            { nome: 'Polvo', desloc: '9m (Nado) / 9m Terrestre + Escalada sem teste', deslocamentoTipo: 'aquatico', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Arma natural', opcao: 'Tentáculos/Cipós' }] },
            { nome: 'Tubarão', desloc: '12m (Nado) / 9m Terrestre', deslocamentoTipo: 'aquatico', deslocamentoValor: 12, tracosSugeridos: [{ nome: 'Arma natural', opcao: 'Presas (Mordida)' }] },
        ],
        'Inseto/Insectóide': [
            { nome: 'Aranha', desloc: '9m (Escalada) / 9m Terrestre', deslocamentoTipo: 'escalada', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Arma natural', opcao: 'Tentáculos/Cipós' }] },
            { nome: 'Besouro Bombardeiro', desloc: '9m Terrestre / 3m (Voo)', deslocamentoTipo: 'voo', deslocamentoValor: 3, tracosSugeridos: [{ nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Impacto' }] },
            { nome: 'Escorpião', desloc: '9m Terrestre', deslocamentoTipo: 'terrestre', deslocamentoValor: 9, tracosSugeridos: [{ nome: 'Veneno/Peçonha' }, { nome: 'Escudo Natural/Carapaça', opcao: 'Resistência a Perfuração' }] },
            { nome: 'Mosquito', desloc: '9m Terrestre / 6m (Voo)', deslocamentoTipo: 'voo', deslocamentoValor: 6, tracosSugeridos: [{ nome: 'Evasão', opcao: 'Aérea' }, { nome: 'Arma natural', opcao: 'Ferrão (Picada)' }] },
        ],
        'Bestas Mágicas': [],
    },
    antecedentes: [
    ...
    inclinacoes: {
        positivas: [
            ...
            { nome: "Ambidestria", custo: 2, desc: "Você luta com ambas as mãos com a mesma precisão e potência. Escolha um dos benefícios:", hasOptions: true, options: [{ label: "Habilidoso em Combate Ágil", custo: 3, desc: "Ao empunhar armas leves em ambas as mãos, realize um ataque com Ação Bônus somando seu modificador no dano de ambos os ataques." }, { label: "Habilidoso em Combate Bruto", custo: 3, desc: "Pode usar qualquer arma sem a propriedade 'Duas Mãos' uma em cada mão como se fosse leve (só ataca com as duas no mesmo turno com Atributo Evoluído ou ataque extra)." }, { label: "Habilidoso em Inventário", custo: 2, desc: "Pega e usa um item, ou troca de equipamento, usando a Ação Bônus." }, { label: "Cirurgião/Malabarista", custo: 2, desc: "+4 em Prestidigitação ou testes de precisão manual que não sejam ataques." }] },
            { nome: "Apropriação Natural/Elemental", custo: 3, desc: "Pré-requisito: Categoria de Transmutação. Escolha um tipo de dano da tabela de forças da natureza igual ao elemento do seu Hatsu. Fica imune a esse tipo de dano e pode tratar 1 dado de dano como valor máximo ao rolar uma habilidade de transmutação elemental com esse elemento." },
            { nome: "Aura Gigantesca", custo: 6, desc: "Dotado de um dom invejável, você possui muito mais aura que pessoas comuns. +30% de Aura máxima." },
            { nome: "Boa Forma", custo: 2, desc: "Seu sistema ósseo e muscular é melhor que o normal. Pode ser escolhida de novo no futuro (quando não repetir a mesma opção).", hasOptions: true, options: [{ label: "Boa Flexibilidade", custo: 2, desc: "+2 em testes de Escalada, testes de Fuga para se livrar de amarras e em tentativas de se libertar em combate corpo a corpo." }, { label: "Ultra Flexibilidade", custo: 4, desc: "Boa Flexibilidade aprimorada — o bônus passa a ser +4." }] },
            { nome: "Destemido", custo: 2, desc: "Difícil de assustar ou intimidar. Vantagem em testes contra Intimidação (CAR ou FOR). Quando é mesmo assustado, sofre 2 de Estresse (dano psíquico) na Sanidade." },
            { nome: "Disparo de Aura", custo: 3, desc: "Passivo para Emissores. Pré-requisito: 80% de assimilação com Emissão (Reforço ou Manipulação). Pode desprender aura pura do corpo em formato de ataque aplicando REN sem precisar de uma arma (5% de aura = 1d6), e atacar à distância com aura ignorando meia ou três-quartos de cobertura." },
            { nome: "Especialista", custo: 2, desc: "Escolha até 2 assuntos (nichados) — dobra a proficiência em testes relacionados a eles." },
            { nome: "Explorador", custo: 2, desc: "Vantagem em testes de Sabedoria (Percepção) e Inteligência (Investigação) para detectar passagens/mecanismos secretos, e vantagem em TRs para evitar ou resistir a armadilhas ao explorar." },
            { nome: "Habitat Natural", custo: 1, desc: "Informe ao mestre um tipo de terreno e condição climática — sempre que estiver nesse ambiente, recebe um bônus em testes correspondente (ex: Ártico = +5 de resistência contra frio)." },
            { nome: "Imponência Assustadora", custo: 3, desc: "Aparência e postura ameaçadoras concedem +3 em iniciativa e em testes de Intimidação." },
            { nome: "Memória Excepcional", custo: 1, desc: "Você se recorda com detalhes de situações e informações. Escolha uma alternativa:", hasOptions: true, options: [{ label: "Memória Excepcional", custo: 1, desc: "Lembra automaticamente de tudo que concentrar atenção; recorda detalhes específicos com teste de INT = 10." }, { label: "Memória Fotográfica", custo: 3, desc: "Como acima, mas também recorda detalhes específicos sempre — o mestre/jogadores devem lembrá-lo como se estivesse tudo anotado ou gravado." }] },
            { nome: "Noção do Perigo", custo: 4, desc: "O mestre faz, em segredo, um teste contra sua Percepção Passiva sempre que houver emboscada, armadilha ou perigo iminente; um sucesso avisa você a tempo de agir. Além disso, Percepção Passiva e Reações aumentam em 3." },
            { nome: "Palpite de Instinto", custo: 3, desc: "Percebe as intenções de quem conversa com você — se é boa/má ou fala verdade. +5 em testes de Intuição ou de CAR contra ser Enganado." },
            { nome: "Pulo do Gato", custo: 3, desc: "Subtrai automaticamente 5m de uma queda (trata como sucesso automático em Acrobacia para quedas simples) e reduz à metade o dano de quedas, desde que não esteja Agarrado/Preso, Atordoado/Incapacitado, Cego, Impedido, Inconsciente ou Paralisado." },
            { nome: "Resistência a Venenos", custo: 2, desc: "Anticorpos poderosos contra qualquer veneno não produzido por aura — +10 em testes de CON contra venenos." },
            { nome: "Tempo de Vida Estendido por Zetsu", custo: 3, desc: "Requisito: Zetsu Intermediário. Seu ciclo de vida se estende em 50 anos a mais em todos os períodos após a infância (70 anos se combinada com Tempo de Vida Estendido por Anomalia)." }
        ],
        negativas: [
            ...
            { nome: "Aleijado", valor: 3, desc: "Perna ruim ou ausente. -2 em qualquer perícia que exija o uso das pernas (incluindo Armas de Mão e combate desarmado, exceto combate à distância). Deslocamento Básico reduzido à metade." },
            { nome: "Anosmia/Ageusia", valor: 1, desc: "Não sente cheiro nem sabor de nada — não detecta certos perigos que outros perceberiam, e falha automaticamente em detectar gases nocivos (mas nunca é afetado por mau odor, e não tem problema em comer qualquer coisa — o que não te dá imunidade a venenos)." },
            { nome: "Azar Perseguidor", valor: 6, desc: "Você é simplesmente azarado. Uma vez por sessão, o mestre usa uma 'Ação Protagonista' (1 d20 extra ou 3d6) para fazer algo dar errado com você — nunca o suficiente para matá-lo de imediato." },
            { nome: "Baixa Destreza Manual ou Consciência Corporal", valor: 1, desc: "Coordenação motora ruim: -2 em qualquer teste baseado em DES (aplicado no resultado final, não causa Atributo Penalizado)." },
            { nome: "Caolho ou Estrábico", valor: 2, desc: "Tem apenas um olho, ou os dois não são confiáveis. -2 em armas de acuidade/à distância e em testes de percepção ou investigação baseados em visão." },
            { nome: "Cegueira", valor: 3, desc: "Perdeu a visão em algum acidente ou nasceu sem ela. Escolha um nível:", hasOptions: true, options: [{ label: "Miopia/Astigmatismo", valor: 3, desc: "50% de perda de visão — reconhece pessoas a 1,5m; ataques à distância com desvantagem." }, { label: "Glaucoma", valor: 4, desc: "80% de perda de visão — vê apenas vultos e localização, sem distinguir o que é cada um." }, { label: "Condição Cego", valor: 5, desc: "Cegueira total — aplica a condição Cego permanentemente." }] },
            { nome: "Covardia", valor: 3, desc: "(Loucura Permanente) Requisito: CAR menor que 15. Diante de perigo, tenta fugir a menos que passe em um teste de coragem/vontade (INT/SAB/CAR, a critério do mestre). -3 em testes para resistir Intimidação." },
            { nome: "Código de Honra", valor: 1, desc: "Segue um conjunto de princípios 'honrosos' o tempo todo, mesmo sob risco de morte. Quebrar o código escolhido causa 5 de Estresse (dano psíquico) na Sanidade. Escolha um:", hasOptions: true, options: [{ label: "Simples", valor: 1, desc: "Sempre se vingar de um insulto; o inimigo de um companheiro é seu inimigo; nunca atacar um companheiro fora de um duelo justo." }, { label: "Cavalheiro", valor: 2, desc: "Nunca faltar com a palavra ou ignorar um insulto a você/sua fé/seus amados; nunca tirar vantagem desleal de um oponente." }, { label: "Soldado", valor: 3, desc: "Lutar e morrer pela honra da tropa; seguir ordens e regras de guerra; tratar inimigos honrosos com respeito." }] },
            { nome: "Cleptomania", valor: 2, desc: "(Loucura Permanente) Compelido a roubar qualquer coisa que possa levar. Ao ter a chance, teste de autocontrole (CAR CD 15) — se falhar, deve roubar; se o furto falhar, sofre 5 de Estresse na Sanidade (recupera 2 ao furtar com sucesso depois)." },
            { nome: "Desinteresse", valor: 2, desc: "(Loucura Permanente) Requisito: INT menor que 15. Dificilmente dá atenção a coisas fora do seu interesse. Teste de autocontrole (INT CD 15) diante de algo estranho/novo — se falhar, simplesmente ignora." },
            { nome: "Desvio de Atenção", valor: 3, desc: "(Loucura Permanente) Requisito: SAB menor que 15. Dificuldade de concentração prolongada — não pode repetir o mesmo teste mais de 3 vezes no mesmo dia sobre a mesma tarefa, e falha automaticamente em testes de provocação ao ser distraído." },
            { nome: "Dupla Personalidade", valor: 4, desc: "Você tem outra personalidade com os mesmos Dado de Vida e Raça, mas atributos/características distintos, que surge ao tirar 1 num dado. Você não controla quando ocorre a mudança, e uma personalidade não lembra o que a outra fez." },
            { nome: "Espírito de Lutador", valor: 3, desc: "Jamais desperdiça a chance de enfrentar alguém mais forte para provar que é o melhor — mesmo já tendo perdido várias vezes por esse impulso." },
            { nome: "Excesso de Confiança", valor: 3, desc: "Requisito: um atributo maior que 18. Acredita ser mais poderoso, inteligente ou competente do que realmente é, e precisa representar isso mesmo quando é perigoso." },
            { nome: "Fantasia", valor: 1, desc: "Crê fielmente em algo que só você acredita (uma 'verdade' criada por você mesmo). -3 em Intimidação e Persuasão contra quem já foi exposto à sua fantasia; deve interpretá-la ao menos 1x a cada 2 sessões." },
            { nome: "Impulsividade", valor: 3, desc: "(Loucura Permanente) Requisito: INT ou SAB menor que 15. Age primeiro e pensa depois. Teste de autocontrole (INT ou SAB CD 15) quando seria melhor esperar — se falhar, age; se impedido de agir, sofre Estresse na Sanidade por rodada." },
            { nome: "Instinto Assassino", valor: 4, desc: "(Loucura Permanente) Precisa matar alguém/algum animal a cada dois dias, ou entra em abstinência com -2 em tudo (dobra por dia adicional sem matar). Pode pegar Código de Honra de graça para simular ser um bom cidadão." },
            { nome: "Legião de Inimigos", valor: 6, desc: "Um grupo, facção ou corporação caça você por motivos diversos (ex: uma máfia por ter matado o filho de um chefe de família)." },
            { nome: "Maneta (Braço)", valor: 4, desc: "Só tem um braço — não pode usar armas de duas mãos nem empunhar duas armas/escudo. -4 em tarefas normalmente feitas com dois braços (ex: Escalada, Luta Livre); sem redutor em tarefas de uma mão só." },
            { nome: "Megalomania", valor: 5, desc: "(Loucura Permanente) Crê ser destinado a grandes coisas. Escolha um objetivo grandioso — enquanto não o concluir, tem apenas metade dos pontos de Sanidade totais." },
            { nome: "Mente de Criança", valor: 2, desc: "(Loucura Permanente) Requisito: não ter antecedente Cientista/Especialista, Criminoso, Líder, Mentalista ou Negociante; não iniciar com tendência Maligna. Ainda tem inocência de criança e é mais facilmente enganado — -5 em testes de Intuição." },
            { nome: "Mudez/Surdez", valor: 4, desc: "Não pode falar ou ouvir. -3 em testes de Carisma; precisa de Prestidigitação (Libras) para passar mensagens a quem não conhece a linguagem de sinais." },
            { nome: "Nanismo", valor: 2, desc: "Não se beneficia do movimento concedido por Atletismo e recebe -1 em iniciativa." },
            { nome: "No Limite/Borderliner", valor: 3, desc: "(Loucura Permanente) Corre riscos absurdamente irracionais diante de perigo mortal e não pode fugir do desafio, ainda que pareça loucura para quem observa." },
            { nome: "Paranoia", valor: 5, desc: "(Loucura Permanente) Perdeu contato com a realidade — acredita que todos conspiram contra você e nunca confia em ninguém (nem em velhos amigos). Por não conseguir aquietar a mente, Zetsu recupera 5% menos aura em qualquer nível." },
            { nome: "Paraplégico", valor: 6, desc: "Não se beneficia do movimento de Atletismo e recebe -5 em iniciativa. Falha automaticamente em TRs de esquiva contra impacto no chão/pernas, é considerado caído em combate, e o movimento total é reduzido a 3m." },
            { nome: "Pesadelos", valor: 3, desc: "(Loucura Permanente) Atormentado todas as noites — o descanso longo recupera apenas metade dos recursos, e a eficiência de aura funciona de forma intermitente (a cada 2 usos)." },
            { nome: "Procurado", valor: 3, desc: "Requisito: não começar com tendência Heróico. Caçado por seus atos por mercenários; a recompensa cresce com sua fama/renome. Valor sugerido de 1 a 8 pontos — negocie com o mestre conforme o momento da escolha." },
            { nome: "Teimosia", valor: 1, desc: "Sempre quer fazer as coisas do seu jeito — seus aliados podem precisar de vários testes de Persuasão para te convencer até de planos razoáveis." },
            { nome: "Trapaceiro", valor: 3, desc: "Requisito: tendência Caótico ou Maligno, e INT ou DES maior que 15. Sente prazer em enganar pessoas perigosas (nunca as inofensivas). Falhar duas vezes com a mesma pessoa, ou perder uma boa chance de trapacear, causa -3 de Estresse na Sanidade." },
            { nome: "Visões de Morte", valor: 5, desc: "(Loucura Permanente) Já esteve perto da morte — sempre que entra em combate, tem uma visão do oponente te matando. -10 em iniciativa; deve descrever essa visão em pensamento ou fala." }
        ]
    },
    skills: [
