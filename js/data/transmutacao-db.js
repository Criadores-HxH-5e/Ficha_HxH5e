    ...
    elemental: [
        { id:'acido', nome:'Ácido', icon:'🧪', cor:'#84cc16',
          ...
          progressao:[
            ...
            { nivel:5, nome:'Queimadura Química', desc:'Aura ácida queima o alvo (necessita líquido ou terra para diluir). Condição: Queimado.' },
            { nivel:6, nome:'Dissolução Proximal', desc:'Derrete o solo ao redor. Inimigos que terminam turno no espaço recebem +1 dado (menor) de dano.' },
        ...
        { id:'agua', nome:'Água/Líquido', icon:'💧', cor:'#38bdf8',
          ...
          progressao:[
            ...
            { nivel:10, nome:'Refração de Aura', desc:'Distorce luz. Inimigos à distância ficam Ofuscados e −5 em Acerto.' },
          ]},
        { id:'vento', nome:'Ar/Vento/Gases', icon:'🌪️', cor:'#a3e635',
          ...
          progressao:[
            ...
            { nivel:5, nome:'Vácuo de Comunicação', desc:'Fina camada impede som/ar do alvo — perde capacidade de falar.' },
        ...
        { id:'fogo', nome:'Fogo', icon:'🔥', cor:'#f97316',
          ...
          progressao:[
            ...
            { nivel:3, nome:'Piromaníaco', desc:'Inimigos que terminam turno no espaço do usuário recebem +1 dado (menor) de dano.' },
        ...
        { id:'terra', nome:'Terra/Areia', icon:'🪨', cor:'#a78bfa',
          ...
          progressao:[
            ...
            { nivel:3, nome:'Areia Movediça', desc:'Prende alvo sobre densa camada de terra/areia. Condição: Enredado/Preso.' },
        ...
        { id:'veneno', nome:'Veneno', icon:'☠️', cor:'#86efac',
          ...
          progressao:[
            ...
            { nivel:3, nome:'Toxina Botulínica', desc:'Relaxamento muscular — −1 em Força OU progressivamente Imóvel → Paralisado.' },
            ...
            { nivel:8, nome:'Toxina Relaxante/Depressora', desc:'Progressivamente: Lentidão → Fragilizado → Inconsciente.' },
            { nivel:8, nome:'Toxina Estimulante', desc:'+1 em perícia de INT ou SAB OU +1 Reação (total).' },
